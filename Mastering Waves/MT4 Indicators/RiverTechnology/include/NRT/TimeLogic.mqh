...
int GetTime_Direction(){return(time_direction);}
...
void Time_SetPeak(){      
   ...
   Time_SetText(text, time_peak, value, time_color);                
}          

void Time_SetText(string text, datetime time, double price, int time_color){      
   string name = "text_" + DoubleToStr(time, 0) + "_" + MathRand();
