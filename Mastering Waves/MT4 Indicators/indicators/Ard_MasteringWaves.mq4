...
//#include <MonoWave\Utils\LimitVersion1.mqh>
//#include <MonoWave\Utils\LimitVersion2.mqh>
...
int start(){   
   ...
   if (!CheckYear_Version() || !CheckAccountWork()) return(0);   
...
void InicializationGlobalVariables(){
   ...
   //DEBUG
   //FileDelete("Direction_Proportion.txt");  
}
